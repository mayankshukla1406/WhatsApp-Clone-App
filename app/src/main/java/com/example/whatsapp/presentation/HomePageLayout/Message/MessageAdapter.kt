...
class MessageAdapter(var listener: IViewsHandling) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            text_message_sender -> TextMessageViewHolderSender(
                MessageTextSenderBinding.inflate(
                    inflater,
                    parent,
                    false
                )
            ...
            text_message_receiver -> TextMessageViewHolderReceiver(
                MessageTextReceiverBinding.inflate(
                    inflater,
                    parent,
                    false
                )
            ...
            image_message_sender -> ImageMessageViewHolderSender(
                MessageImageSenderBinding.inflate(
                    inflater,
                    parent,
                    false
                )
            ...
            image_message_receiver -> ImageMessageViewHolderReceiver(
                MessageImageReceiverBinding.inflate(
                    inflater,
                    parent,
                    false
                )
